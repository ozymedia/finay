...
if (resultat.residence === 'no') {
    ...
    if (resultat.travaux.includes('isolation')) {
      document.querySelector("#elligibilite").querySelector(".secondaire").innerHTML = `Mais vous bénéficiez de ${resultat.ceeAides}€/m<sup>2</sup> avec la prime CEE<br><span class="total-aides">Le total des primes est de ${totalAides}€/m<sup>2</sup></span>`;
    }
    else {
