  ...
  let pictoPrime = document.getElementById("stepByStepForm").querySelector("#prime-color").querySelector("img");
    ...
    sessionStorage.setItem('resultSimulation', JSON.stringify(resultSimulation));
      ...
      if (residence === 'no') {
        ...
        document.querySelector(".step.step4").querySelector("#results").querySelector("#color").innerHTML = "Vous n'êtes pas éligible à MaPrimeRénov'";
        document.querySelector(".step.step4").querySelector("#results").querySelector("#aides").innerText = "";
        if (travauxSelect.includes('isolation')) {
          document.querySelector(".step.step4").querySelector("#results").querySelector("#aides").innerHTML = `Mais vous bénéficiez de ${ceeAides}€/m<sup>2</sup> avec la prime CEE<br><span class="total-aides">Le total des primes est de ${totalAides}€/m<sup>2</sup></span>`;
        }
        else {
          document.querySelector(".step.step4").querySelector("#results").querySelector("#aides").innerHTML = `Mais vous bénéficiez de ${ceeAides}€ avec la prime CEE<br><span class="total-aides">Le total des primes est de ${totalAides}€</span>`;
        }
        ...
        document.querySelector(".step.step4").querySelector("#results").querySelector("#color").innerHTML = `Vous êtes éligible à <span class=${color}>MaPrimeRénov ${color}</span>`;
        if (travauxSelect.includes('isolation')) {
          document.querySelector(".step.step4").querySelector("#results").querySelector("#aides").innerHTML = `<span style="text-decoration:underline;">Vous avez droit à</span> :<br>- ${aides}€/m<sup>2</sup> avec MaPrimeRénov'<br>- ${ceeAides}€/m<sup>2</sup> avec la prime CEE<br><span class="total-aides">Le total des primes est de ${totalAides}€/m<sup>2</sup></span>`;
        }
        else {
          document.querySelector(".step.step4").querySelector("#results").querySelector("#aides").innerHTML = `<span style="text-decoration:underline;">Vous avez droit à</span> :<br>- ${aides}€ pour vos travaux<br>- ${ceeAides}€ supplémentaires avec la prime CEE<br><span class="total-aides">Le total des primes est de ${totalAides}€ </span>`;
        }
      }
